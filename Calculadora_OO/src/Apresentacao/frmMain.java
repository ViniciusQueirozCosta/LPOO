...
public class frmMain extends javax.swing.JFrame
{
    ...
    {   
        ...
        controle.num1 = txfNum1.getText();
        controle.num2 = txfNum2.getText();
        controle.op = op;
        controle.calcular();
        
        if(controle.errorMessage.equals(""))
        {
            txfResult.setText(controle.finalResult);
            
        }
        
        else
        {
            JOptionPane.showMessageDialog(null, controle.errorMessage);
            txfNum1.setText("");
            txfNum2.setText("");
        }
    }
